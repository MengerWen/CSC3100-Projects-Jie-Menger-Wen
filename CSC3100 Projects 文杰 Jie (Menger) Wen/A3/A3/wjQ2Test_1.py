...
for start in range(n):
    ...
    while total_items_taken < bag_size and i < start + n:
        ...
        print("i=", i)
        print("item=", item)
        print("shelf=", shelf, "shelves_taken=", shelves_taken)
        print("total_items_taken=", total_items_taken, "total_value_int=", total_value_int)
        print("-----------一次i结束-------------")
        i += 1
        ...
        if len(counts_list) == len(set(counts_list)):
            if total_value_int > max_total_value_int:
                ...
                print("这里更新max_total_value_int=", max_total_value_int,"!!!!!!!!!!!!!!")
